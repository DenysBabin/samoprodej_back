...
public class ListingService {
    ...
    public ListingResponse create(CreateListingRequest req, UUID ownerId) {
        ...
        Property property = propertyRepository.findById(req.propertyId())
                .orElseThrow(() -> new NotFoundException("Property not found with id: " + req.propertyId()));
    ...
    public ListingResponse unpublish(UUID id) {
        ...
        if (listing.getStatus() != ListingStatus.PUBLISHED) {
            ...
            // Тут використовуємо бізнес-помилку
            throw new BusinessException(ErrorCode.BUSINESS_RULE_VIOLATION, "Listing is not published, cannot unpublish");
        }
